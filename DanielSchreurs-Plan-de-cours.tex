...
\begin{table}[h]
    \begin{tabular}{|p{0.30\textwidth}|p{0.30\textwidth}|p{0.30\textwidth}|}
        ...
        \\ \hline\hline
        Connaitre les concepts                                   & Transmission théorique des concepts + exploration           & \multirow{2}{*}{\begin{tabular}[c]{@{}l@{}}Ils ne doivent pas les réciter mais\\ les mettre en application dans \\ le projet personnel et l'examen\end{tabular}} \\ \cline{1-2}
