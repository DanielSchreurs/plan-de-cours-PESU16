...
\begin{table}[H]
    \begin{tabular}{|l|l|}
        ...
        Évaluation des apprentissages & \begin{tabular}[c]{@{}l@{}}-Réalisation, en classe et individuellement, d'un jeu imposé\\à 2~dimensions dans un navigateur avec l'API de canvas.\\-Réalisation, à domicile et individuellement, d'un jeu personnel\\à 2~dimensions dans un navigateur avec l'API de canvas.\end{tabular}     \\ \hline
    \end{tabular}
\end{table}
\subsection{Justifications}
\begin{itemize}
