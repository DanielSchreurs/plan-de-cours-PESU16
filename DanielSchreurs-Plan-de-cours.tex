...
Je tiens à vous assurer que j'ai particulièrement travaillé la cohérence des objectifs avec la manière dont je vais entrainer et l'évaluation de cet objectif. Cette cohérence vous permettra d'atteindre l'objectif d'apprentissage de manière plus efficace. Mes visées d'apprentissage sont clairement définies et sont en lien avec les compétences que vous devez développer pour devenir de bons programmeurs en JavaScript. J'ai choisi des méthodes d'enseignement varié qui vous permettront de mettre en pratique et de comprendre les concepts dont vous avez besoin faire des sites internet. Enfin, j'ai prévu des évaluations qui vous permettront de mesurer l'acquisition de vos compétences de manière concrète.

En suivant ce cours, vous allez donc travailler sur les concepts fondamentaux de la programmation en JavaScript et vous allez mettre en pratique ce que vous avez appris grâce à beaucoup d'exercices et un projet personnel. Je vais vous donner des exemples concrets pour vous aider à mieux comprendre chaque concept et nous allons avoir des moments d'échanges où vous pourrez poser vos questions et partager vos idées avec moi et avec vos camarades de classe.

Je suis convaincu qu’ensemble et à votre détermination, vous serez en mesure de devenir de véritables experts en JavaScript. Je vous encourage donc à poser toutes les questions que vous avez, à participer activement aux discussions en classe et à travailler pour réussir votre projet personnel et l’examen.
...
\begin{table}[h]
    \begin{tabular}{|p{0.30\textwidth}|p{0.30\textwidth}|p{0.30\textwidth}|}
        ...
        \\ \hline\hline
        Connaître les concepts                                   & Transmission théorique des concepts + exploration           & \multirow{2}{*}{\begin{tabular}[c]{@{}l@{}}Ils ne doivent pas les réciter mais\\ les mettre en application dans \\ le projet personnel et l'examen\end{tabular}} \\ \cline{1-2}
        Comprendre ces concepts                                  & Exercisation - bébat - exploration                          &                                                                                                                                                                  \\ \hline
        Identifier les concepts                                  & Exercisation - l'examen formatif                            & \multirow{3}{*}{\begin{tabular}[c]{@{}l@{}}* Projet personnel\\ * examen pratique\end{tabular}}                                                                  \\ \cline{1-2}
        Savoir combiner différents concepts                      & Création lors des exercices plus complets + examen formatif &                                                                                                                                                                  \\ \cline{1-2}
        Savoir utiliser les outils de développement vus en cours & Imitation et transmission quand j'explique un outil         &                                                                                                                                                                  \\ \hline
    \end{tabular}
\end{table}

Ce tableau, m'assure que j'entraîne mes étudiants aux objectifs du cours et que je les y évalue, mais il montre également que "le projet personnel" et "l'examen pratique" évaluent les mêmes visées d'apprentissages. Cela signifie que, bien que ces évaluations soient différentes en termes de format et de durée, elles ont toutes deux pour objectif final de mesurer la compréhension et la mise en pratique des concepts par mes étudiants.

Il est également important de noter que ces évaluations sont nécessaires pour leur apprentissage. C'est pourquoi j'ai pensé qu'il serait intéressant, afin de soulager mes étudiants et de leur offrir une expérience d'apprentissage encore plus enrichissante, d'évaluer la compréhension des concepts lors d'un examen qui serait alors plus court et de mesurer la mise en pratique et la combinaison des concepts dans le projet personnel. Cela permettrait de varier les évaluations et de donner aux étudiants l'opportunité de mettre en pratique ce qu'ils ont appris de manière approfondie et approfondie.
